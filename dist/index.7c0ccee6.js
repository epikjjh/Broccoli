...
function loadNews(_x) {
    return _loadNews.apply(this, arguments);
} // Only call loadNews if we're in a browser environment
function _loadNews() {
    _loadNews = _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee(rootElementParam) {
        var rootElement, ul, response, newsFeed;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
            while(true)switch(_context.prev = _context.next){
                case 0:
                    // Use passed element or try to find it in DOM
                    rootElement = rootElementParam || document.getElementById('root');
                    if (rootElement) {
                        _context.next = 3;
                        break;
                    }
...
if (typeof window !== 'undefined') {
    ...
    if (rootElement) loadNews(rootElement);
}
